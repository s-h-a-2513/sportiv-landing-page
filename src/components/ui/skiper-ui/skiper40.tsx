...
const Link000 = ({
  ...
  return (
    <a
      href={href}
      className={cn(
        "group relative flex items-center text-ink-muted no-underline hover:text-court hover:no-underline",
        className,
        "before:pointer-events-none before:absolute before:bottom-0 before:left-0 before:h-[0.05em] before:w-full before:bg-court before:content-['']",
...
const Link001 = ({
  ...
  return (
    <a
      ...
      className={cn(
        "group relative flex items-center text-ink-muted no-underline hover:text-court hover:no-underline",
        "before:pointer-events-none before:absolute before:left-0 before:top-[1.5em] before:h-[0.05em] before:w-full before:bg-court before:content-['']",
        "before:origin-right before:scale-x-0 before:transition-transform before:duration-300 before:ease-[cubic-bezier(0.4,0,0.2,1)]",
        "hover:before:origin-left hover:before:scale-x-100",
        className,
      )}
